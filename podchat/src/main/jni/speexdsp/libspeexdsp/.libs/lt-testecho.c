...
/* ./.libs/lt-testecho.c - temporary wrapper executable for .libs/testecho
...
const char * TARGET_PROGRAM_NAME = "testecho"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# testecho - temporary wrapper script for .libs/testecho\n", f);
  ...
  fputs ("    echo \"testecho:testecho:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 Debi", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"testecho:testecho:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"testecho:testecho:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
