...
/* ./.libs/lt-testjitter.c - temporary wrapper executable for .libs/testjitter
...
const char * TARGET_PROGRAM_NAME = "testjitter"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# testjitter - temporary wrapper script for .libs/testjitter\n", f);
  ...
  fputs ("    echo \"testjitter:testjitter:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 ", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"testjitter:testjitter:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"testjitter:testjitter:${LINENO}: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
