...
/* ./.libs/lt-testdenoise.c - temporary wrapper executable for .libs/testdenoise
...
const char * LIB_PATH_VALUE   = "/cygdrive/c/Work/pod-chat-android-sdk/podchat/src/main/jni/speexdsp/libspeexdsp/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/cygdrive/c/Work/pod-chat-android-sdk/podchat/src/main/jni/speexdsp/libspeexdsp/.libs:/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "testdenoise"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# testdenoise - temporary wrapper script for .libs/testdenoise\n", f);
  ...
  fputs ("    echo \"testdenoise:testdenoise:${LINENO}: libtool wrapper (GNU libtool) 2.4.", f);
  fputs ("2 Debian-2.4.2-1.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"testdenoise:testdenoise:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"testdenoise:testdenoise:${LINENO}: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);
  ...
  fputs ("    PATH=/cygdrive/c/Work/pod-chat-android-sdk/podchat/src/main/jni/speexdsp/li", f);
  fputs ("bspeexdsp/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/c/Work/pod-chat-android-sdk/podchat/src/main/jni/speexdsp/l", f);
  fputs ("ibspeexdsp/.libs:$PATH\"\n", f);
  fputs ("\n", f);
