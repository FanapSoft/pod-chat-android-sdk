...
/* ./.libs/lt-testresample.c - temporary wrapper executable for .libs/testresample
...
const char * TARGET_PROGRAM_NAME = "testresample"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# testresample - temporary wrapper script for .libs/testresample\n", f);
  ...
  fputs ("    echo \"testresample:testresample:${LINENO}: libtool wrapper (GNU libtool) 2.", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"testresample:testresample:${LINENO}: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"testresample:testresample:${LINENO}: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
