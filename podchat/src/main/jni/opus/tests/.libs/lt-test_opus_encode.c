...
/* tests/.libs/lt-test_opus_encode.c - temporary wrapper executable for .libs/test_opus_encode
...
const char * TARGET_PROGRAM_NAME = "test_opus_encode"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# tests/test_opus_encode - temporary wrapper script for .libs/test_opus_encode\n", f);
  ...
  fputs ("    echo \"test_opus_encode:tests/test_opus_encode:$LINENO: libtool wrapper (GNU", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_opus_encode:tests/test_opus_encode:$LINENO: newargv[$lt_dump_ar", f);
  fputs ("gs_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_opus_encode:tests/test_opus_encode:$LINENO: newargv[0]: $pr", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_opus_encode'\n", f);
