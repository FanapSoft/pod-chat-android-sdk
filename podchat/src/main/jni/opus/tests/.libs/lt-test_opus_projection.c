...
/* tests/.libs/lt-test_opus_projection.c - temporary wrapper executable for .libs/test_opus_projection
...
const char * TARGET_PROGRAM_NAME = "test_opus_projection"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"test_opus_projection:tests/test_opus_projection:$LINENO: libtool wrap", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_opus_projection:tests/test_opus_projection:$LINENO: newargv[$lt", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_opus_projection:tests/test_opus_projection:$LINENO: newargv", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_opus_projection'\n", f);
