...
/* tests/.libs/lt-test_opus_padding.c - temporary wrapper executable for .libs/test_opus_padding
...
const char * TARGET_PROGRAM_NAME = "test_opus_padding"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"test_opus_padding:tests/test_opus_padding:$LINENO: libtool wrapper (G", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_opus_padding:tests/test_opus_padding:$LINENO: newargv[$lt_dump_", f);
  fputs ("args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_opus_padding:tests/test_opus_padding:$LINENO: newargv[0]: $", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_opus_padding'\n", f);
