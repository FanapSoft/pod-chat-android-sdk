...
/* tests/.libs/lt-test_opus_api.c - temporary wrapper executable for .libs/test_opus_api
...
const char * TARGET_PROGRAM_NAME = "test_opus_api"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# tests/test_opus_api - temporary wrapper script for .libs/test_opus_api\n", f);
  ...
  fputs ("    echo \"test_opus_api:tests/test_opus_api:$LINENO: libtool wrapper (GNU libto", f);
  fputs ("ol) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_opus_api:tests/test_opus_api:$LINENO: newargv[$lt_dump_args_N]:", f);
  fputs (" $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_opus_api:tests/test_opus_api:$LINENO: newargv[0]: $progdir/", f);
  fputs ("$program\" 1>&2\n", f);
