...
/* tests/.libs/lt-test_opus_decode.c - temporary wrapper executable for .libs/test_opus_decode
...
const char * LIB_PATH_VALUE   = "/cygdrive/c/Work/pod-chat-android-sdk/podchat/src/main/jni/opus/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/cygdrive/c/Work/pod-chat-android-sdk/podchat/src/main/jni/opus/.libs:/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "test_opus_decode"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# tests/test_opus_decode - temporary wrapper script for .libs/test_opus_decode\n", f);
  ...
  fputs ("    echo \"test_opus_decode:tests/test_opus_decode:$LINENO: libtool wrapper (GNU", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_opus_decode:tests/test_opus_decode:$LINENO: newargv[$lt_dump_ar", f);
  fputs ("gs_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_opus_decode:tests/test_opus_decode:$LINENO: newargv[0]: $pr", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_opus_decode'\n", f);
  ...
  fputs ("    PATH=/cygdrive/c/Work/pod-chat-android-sdk/podchat/src/main/jni/opus/.libs:", f);
