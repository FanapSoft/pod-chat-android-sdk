...
/* celt/tests/.libs/lt-test_unit_cwrs32.c - temporary wrapper executable for .libs/test_unit_cwrs32
...
const char * TARGET_PROGRAM_NAME = "test_unit_cwrs32"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"test_unit_cwrs32:celt/tests/test_unit_cwrs32:$LINENO: libtool wrapper", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_unit_cwrs32:celt/tests/test_unit_cwrs32:$LINENO: newargv[$lt_du", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_unit_cwrs32:celt/tests/test_unit_cwrs32:$LINENO: newargv[0]", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_unit_cwrs32'\n", f);
