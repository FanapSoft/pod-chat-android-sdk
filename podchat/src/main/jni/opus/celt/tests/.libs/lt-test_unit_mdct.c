...
/* celt/tests/.libs/lt-test_unit_mdct.c - temporary wrapper executable for .libs/test_unit_mdct
...
const char * TARGET_PROGRAM_NAME = "test_unit_mdct"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# celt/tests/test_unit_mdct - temporary wrapper script for .libs/test_unit_mdct\n", f);
  ...
  fputs ("    echo \"test_unit_mdct:celt/tests/test_unit_mdct:$LINENO: libtool wrapper (GN", f);
  fputs ("U libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_unit_mdct:celt/tests/test_unit_mdct:$LINENO: newargv[$lt_dump_a", f);
  fputs ("rgs_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_unit_mdct:celt/tests/test_unit_mdct:$LINENO: newargv[0]: $p", f);
  fputs ("rogdir/$program\" 1>&2\n", f);
