...
/* celt/tests/.libs/lt-test_unit_rotation.c - temporary wrapper executable for .libs/test_unit_rotation
...
const char * TARGET_PROGRAM_NAME = "test_unit_rotation"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"test_unit_rotation:celt/tests/test_unit_rotation:$LINENO: libtool wra", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_unit_rotation:celt/tests/test_unit_rotation:$LINENO: newargv[$l", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_unit_rotation:celt/tests/test_unit_rotation:$LINENO: newarg", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_unit_rotation'\n", f);
