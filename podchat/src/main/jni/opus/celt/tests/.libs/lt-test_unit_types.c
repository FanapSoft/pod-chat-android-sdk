...
/* celt/tests/.libs/lt-test_unit_types.c - temporary wrapper executable for .libs/test_unit_types
...
const char * TARGET_PROGRAM_NAME = "test_unit_types"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"test_unit_types:celt/tests/test_unit_types:$LINENO: libtool wrapper (", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_unit_types:celt/tests/test_unit_types:$LINENO: newargv[$lt_dump", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_unit_types:celt/tests/test_unit_types:$LINENO: newargv[0]: ", f);
