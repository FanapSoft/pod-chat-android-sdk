...
/* celt/tests/.libs/lt-test_unit_laplace.c - temporary wrapper executable for .libs/test_unit_laplace
...
const char * TARGET_PROGRAM_NAME = "test_unit_laplace"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"test_unit_laplace:celt/tests/test_unit_laplace:$LINENO: libtool wrapp", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_unit_laplace:celt/tests/test_unit_laplace:$LINENO: newargv[$lt_", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_unit_laplace:celt/tests/test_unit_laplace:$LINENO: newargv[", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_unit_laplace'\n", f);
