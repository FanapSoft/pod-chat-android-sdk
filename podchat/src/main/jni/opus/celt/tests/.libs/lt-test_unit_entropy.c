...
/* celt/tests/.libs/lt-test_unit_entropy.c - temporary wrapper executable for .libs/test_unit_entropy
...
const char * TARGET_PROGRAM_NAME = "test_unit_entropy"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"test_unit_entropy:celt/tests/test_unit_entropy:$LINENO: libtool wrapp", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_unit_entropy:celt/tests/test_unit_entropy:$LINENO: newargv[$lt_", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_unit_entropy:celt/tests/test_unit_entropy:$LINENO: newargv[", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_unit_entropy'\n", f);
