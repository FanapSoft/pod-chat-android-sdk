...
/* celt/tests/.libs/lt-test_unit_dft.c - temporary wrapper executable for .libs/test_unit_dft
...
const char * TARGET_PROGRAM_NAME = "test_unit_dft"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# celt/tests/test_unit_dft - temporary wrapper script for .libs/test_unit_dft\n", f);
  ...
  fputs ("    echo \"test_unit_dft:celt/tests/test_unit_dft:$LINENO: libtool wrapper (GNU ", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_unit_dft:celt/tests/test_unit_dft:$LINENO: newargv[$lt_dump_arg", f);
  fputs ("s_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_unit_dft:celt/tests/test_unit_dft:$LINENO: newargv[0]: $pro", f);
