...
/* celt/tests/.libs/lt-test_unit_mathops.c - temporary wrapper executable for .libs/test_unit_mathops
...
const char * TARGET_PROGRAM_NAME = "test_unit_mathops"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"test_unit_mathops:celt/tests/test_unit_mathops:$LINENO: libtool wrapp", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_unit_mathops:celt/tests/test_unit_mathops:$LINENO: newargv[$lt_", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_unit_mathops:celt/tests/test_unit_mathops:$LINENO: newargv[", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_unit_mathops'\n", f);
