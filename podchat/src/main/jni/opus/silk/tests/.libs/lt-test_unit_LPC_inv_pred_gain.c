...
/* silk/tests/.libs/lt-test_unit_LPC_inv_pred_gain.c - temporary wrapper executable for .libs/test_unit_LPC_inv_pred_gain
...
const char * TARGET_PROGRAM_NAME = "test_unit_LPC_inv_pred_gain"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("est_unit_LPC_inv_pred_gain\n", f);
  ...
  fputs ("    echo \"test_unit_LPC_inv_pred_gain:silk/tests/test_unit_LPC_inv_pred_gain:$L", f);
  fputs ("INENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_unit_LPC_inv_pred_gain:silk/tests/test_unit_LPC_inv_pred_gain:$", f);
  fputs ("LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_unit_LPC_inv_pred_gain:silk/tests/test_unit_LPC_inv_pred_ga", f);
  fputs ("in:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_unit_LPC_inv_pred_gain'\n", f);
