...
public class Chat extends AsyncAdapter {
    ...
    public void onStateChanged(String state) throws IOException {
        ...
        if (log) {
            listenerManager.callOnLogEvent("Chat State is" + " " + state);
    ...
    public void onReceivedMessage(String textMessage) throws IOException {
        ...
        switch (currentMessageType) {
            ...
            case Constants.CLEAR_HISTORY:
                ...
                listenerManager.callOnClearHistory(gson.toJson(chatResponseClrHistory),chatResponseClrHistory);
                break;
    ...
    public String sendTextMessage(String textMessage, long threadId, Integer messageType, String jsonSystemMetadata
        ...
        try {
            ...
            if (log) {
                ...
                listenerManager.callOnLogEvent("Message with this" + "  uniqueId  " + uniqueId + "  has been added to Message Queue");
            }
            if (chatReady) {
...
//            offsets = 0;
    ...
    private String getErrorOutPut(String errorMessage, long errorCode, String uniqueId) {
        ...
        if (log) {
            ...
            listenerManager.callOnLogEvent("ErrorMessage :" + errorMessage + " *Code* " + errorCode + " *uniqueId* " + uniqueId);
        }
        return jsonError;
    }
...
//            }
            ...
            Logger.e("ErrorOutPut", e.getCause().getMessage());
        }
