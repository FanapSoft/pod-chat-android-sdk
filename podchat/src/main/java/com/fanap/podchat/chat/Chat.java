...
//            deviceIdRequest(ssoHost, socketAddress, appId, severName);
     ...
     */
    public String sendTextMessage(String textMessage, long threadId, Integer messageType, String JsonMetaData, ChatHandler handler) {
