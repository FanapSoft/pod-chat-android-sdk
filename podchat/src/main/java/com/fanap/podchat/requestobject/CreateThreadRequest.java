...
public class CreateThreadRequest extends BaseRequestObject {
    ...
    protected CreateThreadRequest(@NonNull Builder builder) {
        super(builder);
    ...
    public static class Builder extends BaseRequestObject.Builder<Builder> {
        ...
        @NonNull
        @Override
        protected CreateThreadRequest.Builder self() {
            return this;
        }
