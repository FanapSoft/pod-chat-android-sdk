...
public class SendLocationMessageRequest extends BaseRequestMapStImage {
    ...
    public SendLocationMessageRequest(@NonNull Builder builder) {
        super(builder);
    ...
    public static class Builder extends BaseRequestMapStImage.Builder<Builder> {
        ...
        @NonNull
        public SendLocationMessageRequest build() {
            return new SendLocationMessageRequest(this);
        }
