...
public class IntegrationTest {
    ...
    private static String NAME = BaseApplication.getInstance().getString(R.string.integration_server_name);
    private String ssoHost = BaseApplication.getInstance().getString(R.string.ssoHost); // {**REQUIRED**} Socket Address
    private String platformHost = BaseApplication.getInstance().getString(R.string.integration_platformHost); // {**REQUIRED**} Platform Core Address
    private String fileServer = BaseApplication.getInstance().getString(R.string.integration_platformHost);
