...
public class SandboxServerActivity extends AppCompatActivity
        ...
        spinnerThird
                .setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                    ...
                    public void onNothingSelected(AdapterView<?> parent) {
                        Toast.makeText(SandboxServerActivity.this, "\\__('?')__/", Toast.LENGTH_SHORT).show();
                    }
                });
    }
...
//                                Long ubUserId = 121L;
    ...
    private void createThreadWithMessage() {
        ...
        RequestUploadImage requestUploadThreadImageImage = new RequestUploadImage
                .Builder(SandboxServerActivity.this, getUri())
                .setwC(140)
                .sethC(140)
                .build();
...
//        requestRoles.add(requestRole2);
    ...
    private void sendLocationMsg() {
        ...
        RequestLocationMessage requestLocationMessage = new RequestLocationMessage
                ...
                .activity(SandboxServerActivity.this)
...
//            "Choose function",
                    ...
                    case 1:
                        ...
                        presenter.syncContact(SandboxServerActivity.this);
                        break;
                    case 2:
...
//                        presenter.uploadFile(ChatSandBoxActivity.this, getUri());
    ...
    private void retryUpload() {
        ...
        RetryUpload retryUpload = new RetryUpload.Builder().activity(SandboxServerActivity.this).uniqueId(uniqueId).build();
...
//        });
    ...
    private void removeParticipants() {
        ...
        //SET INVITEE LIST
        Invitee invite = new Invitee("5739", InviteType.Constants.TO_BE_CORE_USER_ID);
...
//        invite.add(new Invitee("63271", InviteType.Constants.TO_BE_USER_CONTACT_ID));
        invite.add(new Invitee("2951", InviteType.Constants.TO_BE_USER_CONTACT_ID));
...
//                                invite.add(new Invitee(122, 1));  //user jiji
        ...
        RequestUploadImage requestUploadImage =
                new RequestUploadImage.Builder(SandboxServerActivity.this, getUri())
                        .sethC(140)
                        .setwC(140)
                        .build();
...
//                .offset()
    ...
    public void onUploadImage(View view) {
        ...
        presenter.uploadImageProgress(this, SandboxServerActivity.this, getUri(), new ProgressHandler.onProgress() {
            @Override
            public void onProgressUpdate(String uniqueId, int progress, int totalBytesSent, int totalBytesToSend) {
...
//        presenter.closeChat();
    ...
    public void onUploadFile(View view) {
        ...
        if (getUri() != null) {
            ...
            presenter.uploadFileProgress(SandboxServerActivity.this, this, getUri(), new ProgressHandler.onProgressFile() {
                @Override
