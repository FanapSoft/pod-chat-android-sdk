...
public class ChatIntegrationActivity extends AppCompatActivity
        ...
        spinnerThird
                .setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                    ...
                    public void onNothingSelected(AdapterView<?> parent) {
                        Toast.makeText(ChatIntegrationActivity.this, "\\__('?')__/", Toast.LENGTH_SHORT).show();
                    }
                });
    }
...
//                                Long ubUserId = 121L;
    ...
    private void createThreadWithMessage() {
        ...
        RequestUploadImage requestUploadThreadImageImage = new RequestUploadImage
                .Builder(ChatIntegrationActivity.this, getUri())
                .setwC(140)
                .sethC(140)
                .build();
...
//        requestRoles.add(requestRole2);
    ...
    private void sendLocationMsg() {
        ...
        RequestLocationMessage requestLocationMessage = new RequestLocationMessage
                ...
                .activity(ChatIntegrationActivity.this)
...
//            "Choose function",
                    ...
                    case 1:
                        ...
                        presenter.syncContact(ChatIntegrationActivity.this);
                        break;
                    case 2:
...
//                        presenter.uploadFile(ChatSandBoxActivity.this, getUri());
    ...
    private void retryUpload() {
        ...
        RetryUpload retryUpload = new RetryUpload.Builder().activity(ChatIntegrationActivity.this).uniqueId(uniqueId).build();
...
//        52987 khodam
        ...
        invite.add(new Invitee("63255", InviteType.Constants.TO_BE_USER_CONTACT_ID));
        invite.add(new Invitee("63253", InviteType.Constants.TO_BE_USER_CONTACT_ID));
        invite.add(new Invitee("159014", InviteType.Constants.TO_BE_USER_CONTACT_ID));
        invite.add(new Invitee("63254", InviteType.Constants.TO_BE_USER_CONTACT_ID));
        invite.add(new Invitee("63257", InviteType.Constants.TO_BE_USER_CONTACT_ID));
...
//                                invite.add(new Invitee(122, 1));  //user jiji
        ...
        RequestUploadImage requestUploadImage =
                new RequestUploadImage.Builder(ChatIntegrationActivity.this, getUri())
                        .sethC(140)
                        .setwC(140)
                        .build();
...
//                .offset()
    ...
    public void onUploadImage(View view) {
        ...
        presenter.uploadImageProgress(this, ChatIntegrationActivity.this, getUri(), new ProgressHandler.onProgress() {
            @Override
            public void onProgressUpdate(String uniqueId, int progress, int totalBytesSent, int totalBytesToSend) {
...
//        presenter.closeChat();
    ...
    public void onUploadFile(View view) {
        ...
        if (getUri() != null) {
            ...
            presenter.uploadFileProgress(ChatIntegrationActivity.this, this, getUri(), new ProgressHandler.onProgressFile() {
                @Override
    ...
    public void onGetThreadList(String content, ChatResponse<ResultThreads> thread) {
        ...
        for (Thread th :
            ...
            if (th.getId() == TEST_THREAD_ID) {
                ...
                Log.i(ChatIntegrationActivity.class.getSimpleName(), "Thread last seen message time: " + TEST_THREAD_LAST_SEEN_MESSAGE_TIME + " Cache " + thread.isCache());
            }
