        ...
        spinnerThird
                .setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                    ...
                    public void onNothingSelected(AdapterView<?> parent) {
                        Toast.makeText(MainServerActivity.this, "\\__('?')__/", Toast.LENGTH_SHORT).show();
                    }
                });
    }
...
//                                Long ubUserId = 121L;
    ...
    private void createThreadWithMessage() {
        ...
        RequestUploadImage requestUploadThreadImageImage = new RequestUploadImage
                .Builder(MainServerActivity.this, getUri())
                .setwC(140)
                .sethC(140)
                .build();
...
//        requestRoles.add(requestRole2);
    ...
    private void sendLocationMsg() {
        ...
        RequestLocationMessage requestLocationMessage = new RequestLocationMessage
                ...
                .activity(MainServerActivity.this)
...
//            "Choose function",
                    ...
                    case 1:
                        ...
                        presenter.syncContact(MainServerActivity.this);
                        break;
                    case 2:
...
//                        presenter.uploadFile(ChatSandBoxActivity.this, getUri());
    ...
    private void retryUpload() {
        ...
        RetryUpload retryUpload = new RetryUpload.Builder().activity(MainServerActivity.this).uniqueId(uniqueId).build();
...
//                                invite.add(new Invitee(122, 1));  //user jiji
        ...
        RequestUploadImage requestUploadImage =
                new RequestUploadImage.Builder(MainServerActivity.this, getUri())
                        .sethC(140)
                        .setwC(140)
                        .build();
...
//                .offset()
    ...
    public void onUploadImage(View view) {
        ...
        presenter.uploadImageProgress(this, MainServerActivity.this, getUri(), new ProgressHandler.onProgress() {
            @Override
            public void onProgressUpdate(String uniqueId, int progress, int totalBytesSent, int totalBytesToSend) {
...
//        presenter.closeChat();
    ...
    public void onUploadFile(View view) {
        ...
        if (getUri() != null) {
            ...
            presenter.uploadFileProgress(MainServerActivity.this, this, getUri(), new ProgressHandler.onProgressFile() {
                @Override
